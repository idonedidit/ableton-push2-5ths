...
# Decompiled from: Python 3.6.1 |Anaconda custom (x86_64)| (default, May 11 2017, 13:04:09)
...
# Compiled at: 2017-12-21 01:36:52
...
Layout = namedtuple(b'Layout', ('name', 'interval'))

class ScalesComponent(Component):
    navigation_colors = dict(color=b'Scales.Navigation', disabled_color=b'Scales.NavigationDisabled')
    ...
    root_note_buttons = control_list(RadioButtonControl, control_count=len(ROOT_NOTES), checked_color=b'Scales.OptionOn', unchecked_color=b'Scales.OptionOff')
    in_key_toggle_button = ToggleButtonControl(toggled_color=b'Scales.OptionOn', untoggled_color=b'Scales.OptionOn')
    fixed_toggle_button = ToggleButtonControl(toggled_color=b'Scales.OptionOn', untoggled_color=b'Scales.OptionOff')
...
class ScalesEnabler(Component):
    toggle_button = ButtonControl(color=b'DefaultButton.On')
    ...
    def __init__(self, enter_dialog_mode=None, exit_dialog_mode=None, *a, **k):
        ...
        self._enable_dialog_mode = partial(enter_dialog_mode, b'scales')
        self._exit_dialog_mode = partial(exit_dialog_mode, b'scales')
        return
    ...
    def on_enabled_changed(self):
        ...
        if not self.is_enabled():
            self._exit_dialog_mode()
# okay decompiling /Applications/Ableton Live 10 Beta.app/Contents/App-Resources/MIDI Remote Scripts/Push2/scales_component.pyc
